        ...
        <section className="lg:col-span-6 lg:pt-6">
          ...
          <h1>
            <span className="block font-display text-2xl font-bold uppercase leading-tight tracking-[0.22em] text-cream/55 md:text-3xl">
              <KineticText text="Chào mừng" baseDelay={80} />
            </span>
            <span
              className="mt-4 block font-sans text-[clamp(56px,9.5vw,112px)] font-black leading-[1.05] text-primary"
              style={{
                letterSpacing: '-0.03em',
                animation: 'glow-pulse 4.5s ease-in-out infinite',
              }}
            >
              <KineticText text="trở lại." baseDelay={300} />
            </span>
          </h1>

          <p className="animate-fade-up stagger-3 mt-8 max-w-md text-base leading-relaxed text-cream/70 md:text-lg">
            Một phiên bản tốt hơn của tối Chủ Nhật đang chờ bạn — tìm trận, tìm bạn, ra sân.
          </p>
        ...
        <section className="lg:col-span-6">
          <article className="animate-fade-up stagger-3 relative overflow-hidden rounded-3xl border border-cream/15 bg-gradient-to-br from-cream/[0.06] to-cream/[0.02] p-8 backdrop-blur-2xl shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.08)] md:p-10">
            ...
            <form
              ...
              noValidate
            >
              <Field label="Email hoặc số điện thoại" error={errors.email?.message}>
                <input
                  type="text"
              ...
              <Field label="Mật khẩu" error={errors.password?.message}>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 inline-flex size-9 items-center justify-center rounded-lg text-cream/45 transition hover:bg-cream/[0.06] hover:text-cream focus:outline-none focus:ring-2 focus:ring-primary/40"
                  >
            ...
            {/* Secondary CTA — full-width ghost button matching primary shape */}
            <Link
              to="/register"
